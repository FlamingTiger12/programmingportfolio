"""
This program was my second taste of Python, and my first that actually does anything.
It also has my first Python "for loop" and "if statements".

The program prints the entirety of the lyrics of the popular "99 Bottles" song once.
It accounts for changing the plural "bottles" into singular, when 
"""
